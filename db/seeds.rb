...
Debt.create(value: '313', description: 'testdata', debitor_id: '2', creditor_id: '4')
Debt.create(value: '123', description: 'testdata', debitor_id: '2', creditor_id: '5')
Debt.create(value: '13', description: 'testdata', debitor_id: '2', creditor_id: '6')
Debt.create(value: '25', description: 'testdata', debitor_id: '2', creditor_id: '7')
Debt.create(value: '31', description: 'testdata', debitor_id: '3', creditor_id: '2')
Debt.create(value: '78', description: 'testdata', debitor_id: '3', creditor_id: '5')
...
Debt.create(value: '26', description: 'testdata', debitor_id: '4', creditor_id: '3')
